...
#It should return all matches in an array. If no matches exist, it should return an empty array.
    ...
    #3. To determine if they are anagrams, try determining if they are composed of the same letters.  arrays using the ==
    ...
    #4. Remember that you can split a word into an array of letters using some_word.split(""). You can compare two
      #end
    #end
    #return_array